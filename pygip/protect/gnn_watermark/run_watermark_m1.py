...
from pygip.protect.gnn_watermark.watermark_model import GraphSAGE, WatermarkedGNN
from pygip.protect.gnn_watermark.key_generator import generate_key_input
import os
