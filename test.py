...
def main():
    ...
    if len(sys.argv) == 1:
        ...
        print("  python test.py --all --full")
        print("  python test.py --task node_classification --dataset Cora --model GCN --quick")
        print("  python test.py --task graph_classification --dataset PROTEINS --model GCNMean --quick")
        print("  python test.py --task link_prediction --dataset Cora --model GCN --quick")
        print("  python test.py --task graph_matching --dataset AIDS --model GCNMean --quick")
        return
